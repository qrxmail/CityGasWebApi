...
namespace CityGasWebApi.Models.OperRecord
{
    ...
    /// 储配站运行记录详情（槽车）
    /// </summary>
    public class StorageCarRecordDetail
    {
        ...
        /// 储配站运行记录表（槽车）主键ID
        /// </summary>
        public Guid StorageCarRecordId { get; set; }
        ...
        /// 槽车温度
        /// </summary>
        public double CarTemperature { get; set; }
        ...
        /// 一级换热后温度（℃）
        /// </summary>
        public double HeatExchangeTemperatureOne { get; set; }
